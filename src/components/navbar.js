    ...
    <div>
        ...
        <div className={colorChange ? "navb" : " navb2"}>
          <div class="container-fluid topbar">
            <div className="navbars">
              <a className="tap" href="#work">
                WORK
              </a>

              <a className="tap" href="#About">
                ABOUT ME
              </a>

              <a className="tap" href="#Contact">
                CONTACT
              </a>
            </div>
          </div>
      ...
      <div class={style}>
        <div className={colorChange ? "bar3" : "bar4"}>
          <div onClick={menu} className="hamburger_continer">
        ...
        <nav>
          <ul>
            <li>
              <a onClick={menu} href="#work">
                WORK
              </a>
            </li>
            <li>
              <a onClick={menu} href="#About">
                ABOUT ME
              </a>
            </li>
            <li>
              <a onClick={menu} href="#Contact">
                CONTACT
              </a>
            </li>
          </ul>
